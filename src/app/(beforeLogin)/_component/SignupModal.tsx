            ...
            <div className={style.modal}>
                ...
                <form onSubmit={onSubmit}>
                            ...
                            <label htmlFor="profileImgInput" className={style.uploadLabel}>
                                <div className={style.imagePreview}>
                                    {previewImage ? (
                                        ...
                                        /* 기본 유저 아이콘 */
                                        <svg width={50} viewBox="0 0 24 24" aria-hidden="true" fill="rgb(139, 152, 165)">
                                            <g><path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0 1 12.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 1 1-8 0 4 4 0 0 1 8 0z"></path></g>
                                        </svg>
                                    )}
                                    {/* 카메라 오버레이 아이콘 */}
                                    <div className={style.cameraOverlay}>
                                        <svg width={30} viewBox="0 0 24 24" aria-hidden="true" fill="white">
                                            <g><path d="M19.75 23h-15.5c-1.381 0-2.5-1.119-2.5-2.5V7.5c0-1.381 1.119-2.5 2.5-2.5h1.723l1.5-4h9.054l1.5 4h1.723c1.381 0 2.5 1.119 2.5 2.5v13c0 1.381-1.119 2.5-2.5 2.5zM4.25 7c-.276 0-.5.224-.5.5v13c0 .276.224.5.5.5h15.5c.276 0 .5-.224.5-.5V7.5c0-.276-.224-.5-.5-.5H17.5l-1.5-4h-8l-1.5 4H4.25z"></path><path d="M12 17c-2.761 0-5-2.239-5-5s2.239-5 5-5 5 2.239 5 5-2.239 5-5 5zm0-8c-1.654 0-3 1.346-3 3s1.346 3 3 3 3-1.346 3-3-1.346-3-3-3z"></path></g>
                                        </svg>
                                    </div>
                                </div>
                                <input
                    ...
                    <div className={style.modalFooter}>
                        <button className={style.actionButton} disabled={!isFormValid}>가입하기</button>
                    </div>
                </form>
            </div>
        </div>
